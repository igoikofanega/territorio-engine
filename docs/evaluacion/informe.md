...
| 2020 | 2015-2019 | 8.131 | 5,789 | 0,330 | 7,632 | 9,844 |

**MAE = 5,668 ± 0,171 pp** (2 pliegues,
rango 5,547–5,789).
...
Con embargo 1 el MAE es 5,668; con embargo 2, 6,038. La diferencia
...
- **I = 0,0984** (esperado bajo azar: -0,0001), p = 0,001, n = 8.131
...
|---|---|
| AUC | 0,8677 |
| Brier sin calibrar | 0,07262 |
| Brier calibrado (isotónica) | 0,07439 |
...
|---|---|---|---|
| 0.0-0.1 | 4.959 | 0,015 | 0,013 |
| 0.1-0.2 | 1.414 | 0,161 | 0,132 |
| 0.2-0.3 | 303 | 0,253 | 0,201 |
| 0.3-0.4 | 746 | 0,344 | 0,249 |
| 0.4-0.5 | 269 | 0,448 | 0,342 |
| 0.5-0.6 | 141 | 0,547 | 0,425 |
| 0.6-0.7 | 267 | 0,634 | 0,479 |
| 0.7-0.8 | 1 | 0,753 | 1,000 |
| 0.8-0.9 | 31 | 0,802 | 0,516 |

**Resultado negativo, y se publica igual.** Medida fuera de la muestra en que se ajusta,
la calibración isotónica **no mejora** el Brier (0,07439 frente a
0,07262 sin calibrar). El diagrama enseña por qué: por encima del
...
AUC de 0,87 dice que separa los municipios en riesgo de los que no, y eso es lo
